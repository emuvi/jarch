...
/**
 * A runtime annotation used to inject or enforce a fixed {@code char} value
 * on a field during mapping or configuration.
 *
 * <p>This annotation works heavily in conjunction with the {@link FixVals} interface.
 * When a class implements {@link FixVals}, fields annotated with {@code @FixChar}
...
public @interface FixChar {
    /**
     * @return the fixed char value
     */
    char value();
}
