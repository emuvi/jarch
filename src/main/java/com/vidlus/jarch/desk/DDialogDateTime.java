...
/**
 * A modal dialog tailored for selecting a Date and Time using DEditDateTime.
...
public class DDialogDateTime extends DDialog {
    ...
    /**
     * Retrieves the underlying DEditDateTime component for fluent configuration (e.g., setting font, colors).
     * 
     * @return the internal DEditDateTime instance
     */
     ...
     * @return this DDialogDateTime instance for fluent chaining
     */
