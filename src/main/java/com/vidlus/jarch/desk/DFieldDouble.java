...
/**
 * A specialized edit field for handling Double values.
 * Provides a fluent API for configuration and event handling.
 */
public class DFieldDouble extends DEditField<Double> {

    /**
     * Constructs a new DFieldDouble with a default initial value.
     */
    public DFieldDouble() {
        this(0d);
    }
    ...
    /**
     * Constructs a new DFieldDouble with the specified initial value.
     ...
     * @return This {@code DFieldDouble} instance for fluent chaining.
     */
    @Override
    public DFieldDouble value(Double value) {
        super.value(value);
        return this;
    }
     ...
     */
    @Override
    public DFieldDouble comp(JComponent comp) {
        super.comp(comp);
        return this;
    }
     ...
     */
    @Override
    public DFieldDouble enabled(boolean enabled) {
     ...
     */
    @Override
    public DFieldDouble focusable(boolean focusable) {
     ...
     */
    @Override
    public DFieldDouble requestFocus() {
        super.requestFocus();
        return this;
    }
     ...
     */
    @Override
    public DFieldDouble requestFocusInWindow() {
     ...
     */
    @Override
    public DFieldDouble name(String name) {
        super.name(name);
        return this;
    }
     ...
     */
    @Override
    public DFieldDouble hint(String hint) {
        super.hint(hint);
        return this;
    }
     ...
     */
    @Override
    public DFieldDouble onAction(Consumer<ActionEvent> consumer) {
     ...
     */
    @Override
    public DFieldDouble onMouseClicked(Consumer<MouseEvent> consumer) {
     ...
     */
    @Override
    public DFieldDouble onMousePressed(Consumer<MouseEvent> consumer) {
     ...
     */
    @Override
    public DFieldDouble onMouseReleased(Consumer<MouseEvent> consumer) {
     ...
     */
    @Override
    public DFieldDouble onMouseEntered(Consumer<MouseEvent> consumer) {
     ...
     */
    @Override
    public DFieldDouble onMouseExited(Consumer<MouseEvent> consumer) {
     ...
     */
    @Override
    public DFieldDouble onKeyTyped(Consumer<KeyEvent> consumer) {
     ...
     */
    @Override
    public DFieldDouble onKeyPressed(Consumer<KeyEvent> consumer) {
     ...
     */
    @Override
    public DFieldDouble onKeyReleased(Consumer<KeyEvent> consumer) {
     ...
     */
    @Override
    public DFieldDouble onFocusGained(Consumer<FocusEvent> consumer) {
     ...
     */
    @Override
    public DFieldDouble onFocusLost(Consumer<FocusEvent> consumer) {
     ...
     */
    @Override
    public DFieldDouble cols(int cols) {
        super.cols(cols);
        return this;
    }
     ...
     */
    @Override
    public DFieldDouble editable(boolean editable) {
     ...
     */
    @Override
    public DFieldDouble select(int selectionStart, int selectionEnd) {
     ...
     */
    @Override
    public DFieldDouble selectionStart(int selectionStart) {
     ...
     */
    @Override
    public DFieldDouble selectionEnd(int selectionEnd) {
     ...
     */
    @Override
    public DFieldDouble replaceSelection(String content) {
     ...
     */
    @Override
    public DFieldDouble caretPosition(int position) {
     ...
     */
    @Override
    public DFieldDouble moveCaretPosition(int position) {
     ...
     */
    @Override
    public DFieldDouble horizontalAlignment(int alignment) {
     ...
     */
    @Override
    public DFieldDouble horizontalAlignmentLeft() {
     ...
     */
    @Override
    public DFieldDouble horizontalAlignmentCenter() {
     ...
     */
    @Override
    public DFieldDouble horizontalAlignmentRight() {
     ...
     */
    @Override
    public DFieldDouble horizontalAlignmentLeading() {
     ...
     */
    @Override
    public DFieldDouble horizontalAlignmentTrailing() {
     ...
     */
    @Override
    public DFieldDouble text(String text) {
        super.text(text);
        return this;
    }
     ...
     */
    @Override
    public DFieldDouble font(Font font) {
        super.font(font);
        return this;
    }
     ...
     */
    @Override
    public DFieldDouble foreground(Color color) {
     ...
     */
    @Override
    public DFieldDouble background(Color color) {
     ...
     */
    @Override
    public DFieldDouble caretColor(Color c) {
        super.caretColor(c);
        return this;
    }
     ...
     */
    @Override
    public DFieldDouble disabledTextColor(Color c) {
     ...
     */
    @Override
    public DFieldDouble selectedTextColor(Color c) {
     ...
     */
    @Override
    public DFieldDouble selectionColor(Color c) {
     ...
     */
    @Override
    public DFieldDouble margin(Insets m) {
        super.margin(m);
        return this;
    }
     ...
     */
    @Override
    public DFieldDouble dragEnabled(boolean b) {
        super.dragEnabled(b);
        return this;
    }
     ...
     */
    @Override
    public DFieldDouble dropMode(DropMode m) {
        super.dropMode(m);
        return this;
    }
     ...
     */
    @Override
    public DFieldDouble document(Document doc) {
        super.document(doc);
        return this;
    }
     ...
     */
    @Override
    public DFieldDouble highlighter(Highlighter h) {
        super.highlighter(h);
        return this;
    }
     ...
     */
    @Override
    public DFieldDouble keymap(Keymap map) {
        super.keymap(map);
        return this;
    }
     ...
     */
    @Override
    public DFieldDouble caret(Caret c) {
        super.caret(c);
        return this;
    }
     ...
     */
    @Override
    public DFieldDouble navigationFilter(NavigationFilter filter) {
     ...
     */
    @Override
    public DFieldDouble scrollOffset(int scrollOffset) {
     ...
     */
    @Override
    public DFieldDouble actionCommand(String command) {
     ...
     */
    @Override
    public DFieldDouble focusAccelerator(char aKey) {
     ...
     */
    @Override
    public DFieldDouble opaque(boolean isOpaque) {
     ...
     */
    @Override
    public DFieldDouble border(Border border) {
        super.border(border);
        return this;
    }
