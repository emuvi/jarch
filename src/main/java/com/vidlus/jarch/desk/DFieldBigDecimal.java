...
/**
 * A specialized edit field for handling BigDecimal values.
 * Provides a fluent API for configuration and event handling.
 */
public class DFieldBigDecimal extends DEditField<BigDecimal> {

    /**
     * Constructs a new DFieldBigDecimal with a default initial value.
     */
    ...
    /**
     * Constructs a new DFieldBigDecimal with the specified initial value.
     ...
     * @return This {@code DFieldBigDecimal} instance for fluent chaining.
     */
    @Override
    public DFieldBigDecimal value(java.math.BigDecimal value) {
        super.value(value);
        return this;
    }
     ...
     */
    @Override
    public DFieldBigDecimal comp(JComponent comp) {
        super.comp(comp);
        return this;
    }
     ...
     */
    @Override
    public DFieldBigDecimal enabled(boolean enabled) {
     ...
     */
    @Override
    public DFieldBigDecimal focusable(boolean focusable) {
     ...
     */
    @Override
    public DFieldBigDecimal requestFocus() {
        super.requestFocus();
        return this;
    }
     ...
     */
    @Override
    public DFieldBigDecimal requestFocusInWindow() {
     ...
     */
    @Override
    public DFieldBigDecimal name(String name) {
        super.name(name);
        return this;
    }
     ...
     */
    @Override
    public DFieldBigDecimal hint(String hint) {
        super.hint(hint);
        return this;
    }
     ...
     */
    @Override
    public DFieldBigDecimal onAction(Consumer<ActionEvent> consumer) {
     ...
     */
    @Override
    public DFieldBigDecimal onMouseClicked(Consumer<MouseEvent> consumer) {
     ...
     */
    @Override
    public DFieldBigDecimal onMousePressed(Consumer<MouseEvent> consumer) {
     ...
     */
    @Override
    public DFieldBigDecimal onMouseReleased(Consumer<MouseEvent> consumer) {
     ...
     */
    @Override
    public DFieldBigDecimal onMouseEntered(Consumer<MouseEvent> consumer) {
     ...
     */
    @Override
    public DFieldBigDecimal onMouseExited(Consumer<MouseEvent> consumer) {
     ...
     */
    @Override
    public DFieldBigDecimal onKeyTyped(Consumer<KeyEvent> consumer) {
     ...
     */
    @Override
    public DFieldBigDecimal onKeyPressed(Consumer<KeyEvent> consumer) {
     ...
     */
    @Override
    public DFieldBigDecimal onKeyReleased(Consumer<KeyEvent> consumer) {
     ...
     */
    @Override
    public DFieldBigDecimal onFocusGained(Consumer<FocusEvent> consumer) {
     ...
     */
    @Override
    public DFieldBigDecimal onFocusLost(Consumer<FocusEvent> consumer) {
     ...
     */
    @Override
    public DFieldBigDecimal cols(int cols) {
        super.cols(cols);
        return this;
    }
     ...
     */
    @Override
    public DFieldBigDecimal editable(boolean editable) {
     ...
     */
    @Override
    public DFieldBigDecimal select(int selectionStart, int selectionEnd) {
     ...
     */
    @Override
    public DFieldBigDecimal selectAll() {
        super.selectAll();
        return this;
    }
     ...
     */
    @Override
    public DFieldBigDecimal selectionStart(int selectionStart) {
     ...
     */
    @Override
    public DFieldBigDecimal selectionEnd(int selectionEnd) {
     ...
     */
    @Override
    public DFieldBigDecimal replaceSelection(String content) {
     ...
     */
    @Override
    public DFieldBigDecimal caretPosition(int position) {
     ...
     */
    @Override
    public DFieldBigDecimal moveCaretPosition(int position) {
     ...
     */
    @Override
    public DFieldBigDecimal horizontalAlignment(int alignment) {
     ...
     */
    @Override
    public DFieldBigDecimal horizontalAlignmentLeft() {
     ...
     */
    @Override
    public DFieldBigDecimal horizontalAlignmentCenter() {
     ...
     */
    @Override
    public DFieldBigDecimal horizontalAlignmentRight() {
     ...
     */
    @Override
    public DFieldBigDecimal horizontalAlignmentLeading() {
     ...
     */
    @Override
    public DFieldBigDecimal horizontalAlignmentTrailing() {
     ...
     */
    @Override
    public DFieldBigDecimal text(String text) {
        super.text(text);
        return this;
    }
     ...
     */
    @Override
    public DFieldBigDecimal font(Font font) {
        super.font(font);
        return this;
    }
     ...
     */
    @Override
    public DFieldBigDecimal foreground(Color color) {
     ...
     */
    @Override
    public DFieldBigDecimal background(Color color) {
     ...
     */
    @Override
    public DFieldBigDecimal caretColor(Color c) {
        super.caretColor(c);
        return this;
    }
     ...
     */
    @Override
    public DFieldBigDecimal disabledTextColor(Color c) {
     ...
     */
    @Override
    public DFieldBigDecimal selectedTextColor(Color c) {
     ...
     */
    @Override
    public DFieldBigDecimal selectionColor(Color c) {
     ...
     */
    @Override
    public DFieldBigDecimal margin(Insets m) {
        super.margin(m);
        return this;
    }
     ...
     */
    @Override
    public DFieldBigDecimal dragEnabled(boolean b) {
        super.dragEnabled(b);
        return this;
    }
     ...
     */
    @Override
    public DFieldBigDecimal dropMode(DropMode m) {
        super.dropMode(m);
        return this;
    }
     ...
     */
    @Override
    public DFieldBigDecimal document(Document doc) {
        super.document(doc);
        return this;
    }
     ...
     */
    @Override
    public DFieldBigDecimal highlighter(Highlighter h) {
        super.highlighter(h);
        return this;
    }
     ...
     */
    @Override
    public DFieldBigDecimal keymap(Keymap map) {
        super.keymap(map);
        return this;
    }
     ...
     */
    @Override
    public DFieldBigDecimal caret(Caret c) {
        super.caret(c);
        return this;
    }
     ...
     */
    @Override
    public DFieldBigDecimal navigationFilter(NavigationFilter filter) {
     ...
     */
    @Override
    public DFieldBigDecimal scrollOffset(int scrollOffset) {
     ...
     */
    @Override
    public DFieldBigDecimal actionCommand(String command) {
     ...
     */
    @Override
    public DFieldBigDecimal focusAccelerator(char aKey) {
     ...
     */
    @Override
    public DFieldBigDecimal opaque(boolean isOpaque) {
     ...
     */
    @Override
    public DFieldBigDecimal border(Border border) {
        super.border(border);
        return this;
    }
