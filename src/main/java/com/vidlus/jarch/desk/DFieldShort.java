...
/**
 * A specialized edit field for handling Short values.
 * Provides a fluent API for configuration and event handling.
 */
public class DFieldShort extends DEditField<Short> {

    /**
     * Constructs a new DFieldShort with a default initial value.
     */
    public DFieldShort() {
        this((short) 0);
    }
    ...
    /**
     * Constructs a new DFieldShort with the specified initial value.
     ...
     * @return This {@code DFieldShort} instance for fluent chaining.
     */
    @Override
    public DFieldShort value(Short value) {
        super.value(value);
        return this;
    }
     ...
     */
    @Override
    public DFieldShort comp(JComponent comp) {
        super.comp(comp);
        return this;
    }
     ...
     */
    @Override
    public DFieldShort enabled(boolean enabled) {
     ...
     */
    @Override
    public DFieldShort focusable(boolean focusable) {
     ...
     */
    @Override
    public DFieldShort requestFocus() {
        super.requestFocus();
        return this;
    }
     ...
     */
    @Override
    public DFieldShort requestFocusInWindow() {
     ...
     */
    @Override
    public DFieldShort name(String name) {
        super.name(name);
        return this;
    }
     ...
     */
    @Override
    public DFieldShort hint(String hint) {
        super.hint(hint);
        return this;
    }
     ...
     */
    @Override
    public DFieldShort onAction(Consumer<ActionEvent> consumer) {
     ...
     */
    @Override
    public DFieldShort onMouseClicked(Consumer<MouseEvent> consumer) {
     ...
     */
    @Override
    public DFieldShort onMousePressed(Consumer<MouseEvent> consumer) {
     ...
     */
    @Override
    public DFieldShort onMouseReleased(Consumer<MouseEvent> consumer) {
     ...
     */
    @Override
    public DFieldShort onMouseEntered(Consumer<MouseEvent> consumer) {
     ...
     */
    @Override
    public DFieldShort onMouseExited(Consumer<MouseEvent> consumer) {
     ...
     */
    @Override
    public DFieldShort onKeyTyped(Consumer<KeyEvent> consumer) {
     ...
     */
    @Override
    public DFieldShort onKeyPressed(Consumer<KeyEvent> consumer) {
     ...
     */
    @Override
    public DFieldShort onKeyReleased(Consumer<KeyEvent> consumer) {
     ...
     */
    @Override
    public DFieldShort onFocusGained(Consumer<FocusEvent> consumer) {
     ...
     */
    @Override
    public DFieldShort onFocusLost(Consumer<FocusEvent> consumer) {
     ...
     */
    @Override
    public DFieldShort cols(int cols) {
        super.cols(cols);
        return this;
    }
     ...
     */
    @Override
    public DFieldShort editable(boolean editable) {
     ...
     */
    @Override
    public DFieldShort select(int selectionStart, int selectionEnd) {
     ...
     */
    @Override
    public DFieldShort selectionStart(int selectionStart) {
     ...
     */
    @Override
    public DFieldShort selectionEnd(int selectionEnd) {
     ...
     */
    @Override
    public DFieldShort replaceSelection(String content) {
     ...
     */
    @Override
    public DFieldShort caretPosition(int position) {
     ...
     */
    @Override
    public DFieldShort moveCaretPosition(int position) {
     ...
     */
    @Override
    public DFieldShort horizontalAlignment(int alignment) {
     ...
     */
    @Override
    public DFieldShort horizontalAlignmentLeft() {
     ...
     */
    @Override
    public DFieldShort horizontalAlignmentCenter() {
     ...
     */
    @Override
    public DFieldShort horizontalAlignmentRight() {
     ...
     */
    @Override
    public DFieldShort horizontalAlignmentLeading() {
     ...
     */
    @Override
    public DFieldShort horizontalAlignmentTrailing() {
     ...
     */
    @Override
    public DFieldShort text(String text) {
        super.text(text);
        return this;
    }
     ...
     */
    @Override
    public DFieldShort font(Font font) {
        super.font(font);
        return this;
    }
     ...
     */
    @Override
    public DFieldShort foreground(Color color) {
     ...
     */
    @Override
    public DFieldShort background(Color color) {
     ...
     */
    @Override
    public DFieldShort caretColor(Color c) {
        super.caretColor(c);
        return this;
    }
     ...
     */
    @Override
    public DFieldShort disabledTextColor(Color c) {
     ...
     */
    @Override
    public DFieldShort selectedTextColor(Color c) {
     ...
     */
    @Override
    public DFieldShort selectionColor(Color c) {
     ...
     */
    @Override
    public DFieldShort margin(Insets m) {
        super.margin(m);
        return this;
    }
     ...
     */
    @Override
    public DFieldShort dragEnabled(boolean b) {
        super.dragEnabled(b);
        return this;
    }
     ...
     */
    @Override
    public DFieldShort dropMode(DropMode m) {
        super.dropMode(m);
        return this;
    }
     ...
     */
    @Override
    public DFieldShort document(Document doc) {
        super.document(doc);
        return this;
    }
     ...
     */
    @Override
    public DFieldShort highlighter(Highlighter h) {
        super.highlighter(h);
        return this;
    }
     ...
     */
    @Override
    public DFieldShort keymap(Keymap map) {
        super.keymap(map);
        return this;
    }
     ...
     */
    @Override
    public DFieldShort caret(Caret c) {
        super.caret(c);
        return this;
    }
     ...
     */
    @Override
    public DFieldShort navigationFilter(NavigationFilter filter) {
     ...
     */
    @Override
    public DFieldShort scrollOffset(int scrollOffset) {
     ...
     */
    @Override
    public DFieldShort actionCommand(String command) {
     ...
     */
    @Override
    public DFieldShort focusAccelerator(char aKey) {
     ...
     */
    @Override
    public DFieldShort opaque(boolean isOpaque) {
     ...
     */
    @Override
    public DFieldShort border(Border border) {
        super.border(border);
        return this;
    }
