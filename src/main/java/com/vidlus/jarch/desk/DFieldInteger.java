...
/**
 * A specialized edit field for handling Integer values.
 * Provides a fluent API for configuration and event handling.
 */
public class DFieldInteger extends DEditField<Integer> {

    /**
     * Constructs a new DFieldInteger with a default initial value.
     */
    ...
    /**
     * Constructs a new DFieldInteger with the specified initial value.
     ...
     * @return This {@code DFieldInteger} instance for fluent chaining.
     */
    @Override
    public DFieldInteger value(Integer value) {
        super.value(value);
        return this;
    }
     ...
     */
    @Override
    public DFieldInteger comp(JComponent comp) {
        super.comp(comp);
        return this;
    }
     ...
     */
    @Override
    public DFieldInteger enabled(boolean enabled) {
     ...
     */
    @Override
    public DFieldInteger focusable(boolean focusable) {
     ...
     */
    @Override
    public DFieldInteger requestFocus() {
        super.requestFocus();
        return this;
    }
     ...
     */
    @Override
    public DFieldInteger requestFocusInWindow() {
     ...
     */
    @Override
    public DFieldInteger name(String name) {
        super.name(name);
        return this;
    }
     ...
     */
    @Override
    public DFieldInteger hint(String hint) {
        super.hint(hint);
        return this;
    }
     ...
     */
    @Override
    public DFieldInteger onAction(Consumer<ActionEvent> consumer) {
     ...
     */
    @Override
    public DFieldInteger onMouseClicked(Consumer<MouseEvent> consumer) {
     ...
     */
    @Override
    public DFieldInteger onMousePressed(Consumer<MouseEvent> consumer) {
     ...
     */
    @Override
    public DFieldInteger onMouseReleased(Consumer<MouseEvent> consumer) {
     ...
     */
    @Override
    public DFieldInteger onMouseEntered(Consumer<MouseEvent> consumer) {
     ...
     */
    @Override
    public DFieldInteger onMouseExited(Consumer<MouseEvent> consumer) {
     ...
     */
    @Override
    public DFieldInteger onKeyTyped(Consumer<KeyEvent> consumer) {
     ...
     */
    @Override
    public DFieldInteger onKeyPressed(Consumer<KeyEvent> consumer) {
     ...
     */
    @Override
    public DFieldInteger onKeyReleased(Consumer<KeyEvent> consumer) {
     ...
     */
    @Override
    public DFieldInteger onFocusGained(Consumer<FocusEvent> consumer) {
     ...
     */
    @Override
    public DFieldInteger onFocusLost(Consumer<FocusEvent> consumer) {
     ...
     */
    @Override
    public DFieldInteger cols(int cols) {
        super.cols(cols);
        return this;
    }
     ...
     */
    @Override
    public DFieldInteger editable(boolean editable) {
     ...
     */
    @Override
    public DFieldInteger select(int selectionStart, int selectionEnd) {
     ...
     */
    @Override
    public DFieldInteger selectAll() {
        super.selectAll();
        return this;
    }
     ...
     */
    @Override
    public DFieldInteger selectionStart(int selectionStart) {
     ...
     */
    @Override
    public DFieldInteger selectionEnd(int selectionEnd) {
     ...
     */
    @Override
    public DFieldInteger replaceSelection(String content) {
     ...
     */
    @Override
    public DFieldInteger caretPosition(int position) {
     ...
     */
    @Override
    public DFieldInteger moveCaretPosition(int position) {
     ...
     */
    @Override
    public DFieldInteger horizontalAlignment(int alignment) {
     ...
     */
    @Override
    public DFieldInteger horizontalAlignmentLeft() {
     ...
     */
    @Override
    public DFieldInteger horizontalAlignmentCenter() {
     ...
     */
    @Override
    public DFieldInteger horizontalAlignmentRight() {
     ...
     */
    @Override
    public DFieldInteger horizontalAlignmentLeading() {
     ...
     */
    @Override
    public DFieldInteger horizontalAlignmentTrailing() {
     ...
     */
    @Override
    public DFieldInteger text(String text) {
        super.text(text);
        return this;
    }
     ...
     */
    @Override
    public DFieldInteger font(Font font) {
        super.font(font);
        return this;
    }
     ...
     */
    @Override
    public DFieldInteger foreground(Color color) {
     ...
     */
    @Override
    public DFieldInteger background(Color color) {
     ...
     */
    @Override
    public DFieldInteger caretColor(Color c) {
        super.caretColor(c);
        return this;
    }
     ...
     */
    @Override
    public DFieldInteger disabledTextColor(Color c) {
     ...
     */
    @Override
    public DFieldInteger selectedTextColor(Color c) {
     ...
     */
    @Override
    public DFieldInteger selectionColor(Color c) {
     ...
     */
    @Override
    public DFieldInteger margin(Insets m) {
        super.margin(m);
        return this;
    }
     ...
     */
    @Override
    public DFieldInteger dragEnabled(boolean b) {
        super.dragEnabled(b);
        return this;
    }
     ...
     */
    @Override
    public DFieldInteger dropMode(DropMode m) {
        super.dropMode(m);
        return this;
    }
     ...
     */
    @Override
    public DFieldInteger document(Document doc) {
        super.document(doc);
        return this;
    }
     ...
     */
    @Override
    public DFieldInteger highlighter(Highlighter h) {
        super.highlighter(h);
        return this;
    }
     ...
     */
    @Override
    public DFieldInteger keymap(Keymap map) {
        super.keymap(map);
        return this;
    }
     ...
     */
    @Override
    public DFieldInteger caret(Caret c) {
        super.caret(c);
        return this;
    }
     ...
     */
    @Override
    public DFieldInteger navigationFilter(NavigationFilter filter) {
     ...
     */
    @Override
    public DFieldInteger scrollOffset(int scrollOffset) {
     ...
     */
    @Override
    public DFieldInteger actionCommand(String command) {
     ...
     */
    @Override
    public DFieldInteger focusAccelerator(char aKey) {
     ...
     */
    @Override
    public DFieldInteger opaque(boolean isOpaque) {
     ...
     */
    @Override
    public DFieldInteger border(Border border) {
        super.border(border);
        return this;
    }
