...
public class WizZonedDateTime {
    ...
    public static ZonedDateTime get(Object data) throws Exception {
        if (data == null) {
            return null;
        }
        if (WizLang.isChildOf(data.getClass(), ZonedDateTime.class)) {
            return ZonedDateTime.class.cast(data);
        }
