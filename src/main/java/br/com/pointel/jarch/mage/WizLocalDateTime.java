...
public class WizLocalDateTime {
    ...
    public static LocalDateTime get(Object data) throws Exception {
        if (data == null) {
            return null;
        }
        if (WizLang.isChildOf(data.getClass(), LocalDateTime.class)) {
            return LocalDateTime.class.cast(data);
        }
